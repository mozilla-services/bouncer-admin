...
def test_location_add_product_not_found(client):
    rv = client.post('api/location_add',
                     data=dict(product='FakeProduct',
                               path='/test_path',
                               os='osx'))
...
def test_location_add_os_not_found(client):
    rv = client.post('api/location_add',
                     data=dict(product='Firefox', path='/test_path',
                               os='fake'))
...
def test_location_add(client):
    rv = client.post('api/location_add',
                     data=dict(product='AaronProduct',
                               path='/test_path',
                               os='win64'))
...
def test_location_modify_invalid_product(client):
    rv = client.post('api/location_modify',
                     data=dict(product='FakeProduct',
                               os='osx',
                               path='/newpath'))
    expected = b'<?xml version="1.0" encoding="utf-8"?><error number="104">FAILED: \'FakeProduct\' does not exist</error>'
...
def test_location_modify_invalid_os(client):
    rv = client.post('api/location_modify',
                     data=dict(product='Firefox', os='fakeos',
                               path='/newpath'))
...
def test_product_add_no_match(client):
    rv = client.post('api/product_add',
                     data=dict(product='AaronProduct',
                               ssl_only='osx',
                               languages={'en-GB'}))
...
def test_product_add(client):
    rv = client.post('api/product_add',
                     data={
                         'product': 'Fake',
                         'ssl_only': 'True',
                         'languages': '%5B%27en-CA%27%2C%27en-US%27%5D'
                     })
...
def test_product_language_add(client):
    rv = client.post('api/product_language_add',
                     data={
                         'product': 'AaronProduct',
                         'languages': '%5B%27fr-FR%27%2C%20%27es-SP%27%5D'
                     })
...
def test_product_language_delete(client):
    rv = client.post('api/product_language_delete',
                     data={
                         'product': 'AaronProduct',
                         'languages': '%5B%27en-GB%27%2C%20%27en-US%27%5D'
                     })
...
def test_create_update_alias_no_product_match(client):
    rv = client.post('api/create_update_alias',
                     data={
                         'alias': 'aaron-product',
                         'related_product': 'FakeProduct'
                     })
